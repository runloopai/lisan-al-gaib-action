export const id = 967;
export const ids = [967];
export const modules = {

/***/ 2673:
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "1b231d2ddde689c94d30.wasm";
...
/* harmony export */ });
/* unused harmony exports CaptureQuantifier, Edit, LANGUAGE_VERSION, LookaheadIterator, MIN_COMPATIBLE_VERSION, Node, Query, Tree, TreeCursor */
  ...
  */
  ...
  static async load(input) {
    ...
    if (input instanceof Uint8Array) {
      ...
      const fs2 = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 1943, 19));
...
async function Module2(moduleArg = {}) {
  ...
  if (ENVIRONMENT_IS_NODE) {
    const { createRequire } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 3339, 19));
  ...
  function findWasmBinary() {
    ...
    return new URL(/* asset import */ __webpack_require__(2673), __webpack_require__.b).href;
  }
